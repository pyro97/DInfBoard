...
<div class="row">
  ...
  <div class="right" style="background-color:#005999;">
        <h1 class="titolo">Rimuovi Admin</h1>
    
	
		<div id="div-deleteAdmin">
	
		<form action="EliminaAmministratoreServlet" method=get>
				<p> Username</p>
			<input type="text" id="username" name="usernameAdmin" placeholder="Inserisci.."><br>
			
			<button id="submitDeleteAdmin">Rimuovi</button>
